...
/turf/open/floor/carpet/blackred
	...
	smoothing_groups = list(SMOOTH_GROUP_TURF_OPEN, SMOOTH_GROUP_CARPET_BLACK, SMOOTH_GROUP_CARPET_BLACK_RED, SMOOTH_GROUP_CARPET_RED)
	canSmoothWith = list(SMOOTH_GROUP_CARPET_BLACK_RED)
...
/turf/open/floor/carpet/monochrome
	...
	smooth = SMOOTH_MORE
	smoothing_groups = list(SMOOTH_GROUP_TURF_OPEN, SMOOTH_GROUP_CARPET_MONOCHROME)
	canSmoothWith = list(SMOOTH_GROUP_CARPET_ROYAL_MONOCHROME)
